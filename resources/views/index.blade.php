...
<style>  
  ...
  <body id="body-pd">
    <header class="header" style="background: pink" id="header">
        <div class="header_toggle"> <i class='bx bx-menu' id="header-toggle"></i> </div>
        <div class="header_img"> <img src="https://i.imgur.com/hczKIze.jpg" alt=""> </div>
    </header>
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a   class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Post</span> </a>
                <div class="nav_list"> 
                  <a href="/userDataPage" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Your Data</span> </a>
                   <a href="/userpost" class="nav_link"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Your Post</span> </a>
                    <a href="#" class="nav_link"> <i class='bx bx-message-square-detail nav_icon'></i> <span class="nav_name">Public Post</span> </a> 
